const days = [
  ...
  { date:"01.09", weekday:"SAT", city:"札幌", title:"啤酒文化與最後購物", tone:"snow", stops:[
    ["07:30","札幌場外市場・海鮮早餐","前往中央卸売市場場外市場吃海鮮丼或壽司；各店營業時間不同，餐廳選定後再確認。"],
    ["09:30","北海道廳紅磚廳舍","回到市中心參觀修復後的館內展示與八角塔展望空間；目前 08:45 開館。"],
    ["10:30","前往札幌啤酒博物館","從札幌站附近搭巴士或步行前往，預留入場前緩衝。"],
    ["11:00","札幌啤酒博物館","開館後入場參觀；2026 年改裝後自由參觀與導覽皆需購票，導覽建議預約。"],
    ["12:45","札幌市區午餐","參觀後返回札幌站或大通簡單用餐；早餐吃得較飽時可改咖啡休息。"],
