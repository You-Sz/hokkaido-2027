const days = [
  ...
  { date:"01.02", weekday:"SAT", city:"札幌", title:"札幌建築散步與初賣", tone:"ice", stops:[
    ["08:45","北海道廳紅磚廳舍","目前公布 1/1–1/3 室內休館，先逛前庭、拍建築外觀；室內參觀留待日後補看。"],
    ["09:40","札幌時計台・大通公園","看時計台外觀並沿大通公園散步；年始室內開放時間需再確認。"],
    ["10:40","札幌電視塔","登塔俯瞰大通；若年始延後開門，就先逛大通周邊再回來。"],
    ["11:45","札幌市區午餐","在大通附近選擇年始有營業的餐廳，午餐後直接前往百貨商圈。"],
    ["13:00","百貨商圈・初賣","逛丸井今井、三越與地下街；實際年始營業時間年底再確認。"],
  ...
  { date:"01.04", weekday:"MON", city:"小樽", title:"沿著堺町走向運河暮色", tone:"blue", stops:[
    ...
    ["09:40","吉伊卡哇 MOGUMOGU 本舖小樽店","到堺町 6-1 購買小樽限定商品；目前須透過官方 LINE 事前預約入店。"],
    ["10:00","蒸汽鐘整點表演","商店就在蒸汽鐘附近，09:55 前到鐘前等候整點表演。"],
    ["10:10","小樽音樂盒堂本館","從蒸汽鐘旁進入本館參觀與選購。"],
    ["11:30","宝すし（Takara Sushi）","前往花園 1 丁目享用壽司午餐；午間僅營業至 14:00，務必事先訂位。"],
    ["13:00","Un délice 住ノ江創業本店","午餐後往南折返，購買布丁大福；年始營業時間仍需再次確認。"],
    ["13:40","北菓樓小樽本館","回到堺町通，購買泡芙與伴手禮。"],
  ...
  { date:"01.09", weekday:"SAT", city:"札幌", title:"啤酒文化與最後購物", tone:"snow", stops:[
    ["10:15","前往札幌啤酒博物館","從札幌站搭巴士或步行前往，預留入場前緩衝。"],
    ["11:00","札幌啤酒博物館","開館後入場參觀；2026 年改裝後自由參觀與導覽皆需購票，導覽建議預約。"],
    ["12:30","札幌市區午餐","參觀後返回札幌站或大通用餐。"],
    ["14:00","札幌站商圈・最後購物","逛大丸、Stellar Place、地下街，補齊伴手禮。"],
...
export default function Home(){return <main>
  ...
  <section className="notes" id="notes"><div className="shell"><div className="sectionHeading light"><p>NOTES BEFORE DEPARTURE</p><h2>出發前最後確認</h2></div><div className="notesGrid"><article><b>01</b><h3>元旦北海道神宮</h3><p>元旦近年約 18:00 關門，這個安排非常吃入境速度。若 16:40 還沒抵達飯店，1/1 直接改市區晚餐與休息；1/8 早上仍會前往北海道神宮與圓山一帶。</p></article><article><b>02</b><h3>年始營業</h3><p>紅磚廳舍目前公布 1/1–1/3 室內休館；時計台、電視塔、百貨、餐廳與小樽各店的 2027 年始時間，請於 2026 年 11–12 月再確認。</p></article><article><b>03</b><h3>洞爺交通</h3><p>洞爺站、溫泉街與有珠山並非步行範圍。先確認飯店接駁，再預約計程車或包車前往昭和新山。</p></article><article><b>04</b><h3>風雪備案</h3><p>函館山與有珠山纜車可能因強風停駛；藻岩山放在 1/9 傍晚備用，支笏湖則保留為可替換 1/9 全日的方案。</p></article><article><b>05</b><h3>指定席・餐廳</h3><p>特急北斗建議提早預約指定席；1/8 成吉思汗烤肉店與 1/9 啤酒博物館導覽也建議事先預約。</p></article><article><b>06</b><h3>時間性質</h3><p>頁面中的時間是順路規劃值，JR、巴士、飯店接駁與旅行團時間須以正式預約資料覆蓋。</p></article></div></div></section>
